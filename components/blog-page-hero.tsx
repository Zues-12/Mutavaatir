...
export default function BlogPageHero() {
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute inset-0 z-1 bg-brand-void/75"
        aria-hidden
      />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-16 text-center sm:px-6 sm:py-20 lg:px-8 lg:py-28">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-brand-mist sm:text-lg">
          Discover thoughtful reviews, curated reading lists, literary essays, conversations about literature and everything in between.
        </p>
      </div>
    </section>
  );
