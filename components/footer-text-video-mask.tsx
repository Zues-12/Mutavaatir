...
const VIDEO_OBJECT_POSITION = '50% 60%' // e.g. '50% 0%' = top, '50% 100%' = bottom, '0% 50%' = left
...
export default function FooterTextVideoMask() {
  ...
  return (
    <div
      className="pointer-events-none absolute bottom-0 left-0 right-0 z-0 w-full translate-y-1/3 select-none overflow-hidden opacity-22"
